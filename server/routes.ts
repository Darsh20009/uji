...
router.get("/settings", async (_req, res) => {
  const keys = ["storeName","storePhone","storeEmail","shippingFee","shippingFreeThreshold","maintenanceMode","whatsapp","trustBadges","trustBadgesPosition","_codEnabled","_bankEnabled","_stcEnabled","bankIban","bankName","stcPayNumber","deliveryProviders","social"];
