export default function RitualPage() {
  const steps = [
    {
      num: "٠١", en: "SIFT",
      ar: "النخل",
      desc: "انخل ملعقة صغيرة من الماتشا (٣–٤ غرام) في وعاء التشاوان لتفكيك أي تكتلات وضمان ناعومة مثالية.",
    ...
    },
    {
      num: "٠٣", en: "WHISK",
      ar: "الخفق",
      desc: "أضف ٤٠ مل من الماء ثم اخفق بحركة W سريعة لمدة ٣٠ ثانية حتى يتشكل رغوة ناعمة على السطح.",
      detail: "استخدم المشة البامبو (Chasen) من الوسط للخارج، لا بحركة دائرية.",
    },
    {
      num: "٠٤", en: "POUR",
      ar: "الصبّ",
    ...
    },
    {
      num: "٠٥", en: "SAVOUR",
      ar: "التذوق",
      desc: "قبل أول رشفة، شمّ العطر، لاحظ اللون الزمردي، واشعر بالدفء في يديك. هذا هو الريتشوال.",
  ...
  const tips = [
    ...
    { icon: "⚖️", title: "الكمية", body: "٣–٤ غرام لكل ٤٠ مل ماء" },
    { icon: "🎋", title: "المخفقة", body: "احفظها في حامل بعد الاستخدام لتدوم أكثر" },
