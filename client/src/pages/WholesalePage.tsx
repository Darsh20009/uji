...
export default function WholesalePage() {
  ...
  const message = encodeURIComponent(
    `${lang === "ar" ? "مرحباً فريق UJI، أرغب في تقديم ماتشا UJI في مشروعي." : "Hello UJI team, I would like to serve UJI matcha in my business."}

${lang === "ar" ? "اسم المشروع:" : "Business name:"}
${lang === "ar" ? "قطاع النشاط:" : "Industry:"}
${lang === "ar" ? "الدولة والمدينة:" : "Country and city:"}
${lang === "ar" ? "الاستخدام المتوقع:" : "Expected usage:"}
${lang === "ar" ? "الدرجة التي أرغب بتجربتها:" : "Grade I would like to try:"}`
  );
